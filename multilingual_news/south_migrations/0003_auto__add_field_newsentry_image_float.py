...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NewsEntry.image_float'
        db.add_column(u'multilingual_news_newsentry', 'image_float',
                      self.gf('django.db.models.fields.CharField')(default='none', max_length=8),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NewsEntry.image_float'
        db.delete_column(u'multilingual_news_newsentry', 'image_float')
    ...
    models = {
        ...
        u'multilingual_news.newsentry': {
            ...
            'image_float': ('django.db.models.fields.CharField', [], {'default': "'none'", 'max_length': '8'}),
