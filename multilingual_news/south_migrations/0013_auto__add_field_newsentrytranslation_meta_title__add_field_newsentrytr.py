...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NewsEntryTranslation.meta_title'
        db.add_column(u'multilingual_news_newsentry_translation', 'meta_title',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)

        # Adding field 'NewsEntryTranslation.meta_description'
        db.add_column(u'multilingual_news_newsentry_translation', 'meta_description',
                      self.gf('django.db.models.fields.TextField')(max_length=512, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NewsEntryTranslation.meta_title'
        db.delete_column(u'multilingual_news_newsentry_translation', 'meta_title')

        # Deleting field 'NewsEntryTranslation.meta_description'
        db.delete_column(u'multilingual_news_newsentry_translation', 'meta_description')
