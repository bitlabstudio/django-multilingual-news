...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'NewsEntryTitle'
        db.delete_table(u'multilingual_news_newsentrytitle')


    def backwards(self, orm):
        # Adding model 'NewsEntryTitle'
        db.create_table(u'multilingual_news_newsentrytitle', (
            ('language', self.gf('django.db.models.fields.CharField')(max_length=5)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=512)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('entry', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['multilingual_news.NewsEntry'])),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=512)),
            ('is_published', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'multilingual_news', ['NewsEntryTitle'])
