...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        orm['cms.Placeholder'].objects.filter(slot='multilingnual_news_content').update(slot='multilingual_news_content')
        orm['cms.Placeholder'].objects.filter(slot='multilingnual_news_excerpt').update(slot='multilingual_news_excerpt')
