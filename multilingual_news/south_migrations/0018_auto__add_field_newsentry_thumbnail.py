...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NewsEntry.thumbnail'
        db.add_column(u'multilingual_news_newsentry', 'thumbnail',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='entries_with_thumbnails', null=True, to=orm['filer.Image']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NewsEntry.thumbnail'
        db.delete_column(u'multilingual_news_newsentry', 'thumbnail_id')
    ...
    models = {
        ...
        u'multilingual_news.category': {
            ...
            'hide_on_list': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'multilingual_news.newsentry': {
            ...
            'thumbnail': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'entries_with_thumbnails'", 'null': 'True', 'to': "orm['filer.Image']"})
        },
        ...
        u'people.person': {
            ...
            'picture': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['filer.File']", 'null': 'True', 'blank': 'True'}),
