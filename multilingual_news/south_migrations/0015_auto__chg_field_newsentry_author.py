...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'NewsEntry.author'
        db.alter_column(u'multilingual_news_newsentry', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['people.Person'], null=True))

        for entry in orm['multilingual_news.NewsEntry'].objects.all():
            try:
                entry.author = orm['people.Person'].objects.get(email=entry.author_user.email)
            except:
                pass
            else:
                entry.save()
    ...
    def backwards(self, orm):
        ...
        # Changing field 'NewsEntry.author'
        db.alter_column(u'multilingual_news_newsentry', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))
