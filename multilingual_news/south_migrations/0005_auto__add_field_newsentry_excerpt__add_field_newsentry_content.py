...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'multilingual_news_newsentry', 'excerpt',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='multilingual_news_excerpts', null=True, to=orm['cms.Placeholder']),
                      keep_default=False)

        # Adding field 'NewsEntry.content'
        db.add_column(u'multilingual_news_newsentry', 'content',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='multilingual_news_contents', null=True, to=orm['cms.Placeholder']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NewsEntry.excerpt'
        db.delete_column(u'multilingual_news_newsentry', 'excerpt_id')

        # Deleting field 'NewsEntry.content'
        db.delete_column(u'multilingual_news_newsentry', 'content_id')
