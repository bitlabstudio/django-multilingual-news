...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'multilingual_news_category', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('creation_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=512)),
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['multilingual_news.Category'], null=True, blank=True)),
        ))
        db.send_create_signal(u'multilingual_news', ['Category'])

        # Adding model 'CategoryPlugin'
        db.create_table(u'multilingual_news_categoryplugin', (
            (u'cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('template_argument', self.gf('django.db.models.fields.CharField')(max_length=20, blank=True)),
        ))
        db.send_create_signal(u'multilingual_news', ['CategoryPlugin'])

        # Adding M2M table for field categories on 'CategoryPlugin'
        m2m_table_name = db.shorten_name(u'multilingual_news_categoryplugin_categories')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('categoryplugin', models.ForeignKey(orm[u'multilingual_news.categoryplugin'], null=False)),
            ('category', models.ForeignKey(orm[u'multilingual_news.category'], null=False))
        ))
        db.create_unique(m2m_table_name, ['categoryplugin_id', 'category_id'])

        # Adding model 'CategoryTranslation'
        db.create_table(u'multilingual_news_category_translation', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=256)),
            ('language_code', self.gf('django.db.models.fields.CharField')(max_length=15, db_index=True)),
            ('master', self.gf('django.db.models.fields.related.ForeignKey')(related_name='translations', null=True, to=orm['multilingual_news.Category'])),
        ))
        db.send_create_signal(u'multilingual_news', ['CategoryTranslation'])
    ...
    def backwards(self, orm):
        ...
        db.delete_unique(u'multilingual_news_category_translation', ['language_code', 'master_id'])

        # Deleting model 'Category'
        db.delete_table(u'multilingual_news_category')

        # Deleting model 'CategoryPlugin'
        db.delete_table(u'multilingual_news_categoryplugin')

        # Removing M2M table for field categories on 'CategoryPlugin'
        db.delete_table(db.shorten_name(u'multilingual_news_categoryplugin_categories'))
