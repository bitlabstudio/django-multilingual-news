...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RecentPlugin'
        db.create_table(u'cmsplugin_recentplugin', (
            (u'cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('limit', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('current_language_only', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'multilingual_news', ['RecentPlugin'])


    def backwards(self, orm):
        # Deleting model 'RecentPlugin'
        db.delete_table(u'cmsplugin_recentplugin')
