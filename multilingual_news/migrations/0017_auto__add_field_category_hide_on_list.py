...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Category.hide_on_list'
        db.add_column(u'multilingual_news_category', 'hide_on_list',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Category.hide_on_list'
        db.delete_column(u'multilingual_news_category', 'hide_on_list')
