...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'multilingual_news_newsentry_translation', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=512)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=512)),
            ('is_published', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('language_code', self.gf('django.db.models.fields.CharField')(max_length=15, db_index=True)),
            ('master', self.gf('django.db.models.fields.related.ForeignKey')(related_name='translations', null=True, to=orm['multilingual_news.NewsEntry'])),
        ))
        db.send_create_signal(u'multilingual_news', ['NewsEntryTranslation'])

        # Adding unique constraint on 'NewsEntryTranslation', fields ['language_code', 'master']
        db.create_unique(u'multilingual_news_newsentry_translation', ['language_code', 'master_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'NewsEntryTranslation', fields ['language_code', 'master']
        db.delete_unique(u'multilingual_news_newsentry_translation', ['language_code', 'master_id'])

        # Deleting model 'NewsEntryTranslation'
        db.delete_table(u'multilingual_news_newsentry_translation')
